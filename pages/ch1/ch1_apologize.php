...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="" href="../../img/t.ico">
    </head>
    <body>
        <div class = "header-image overlay">
            <a href="../../index.php" class="restart">Restart?</a>
            <div class = "ptext">
                <p>
                ...
                <p>
                    The seats were a jet <span style = "color: #222">black</span> colored leather, with clear steel frame. They were sturdy, enough to carry the people and the trouble they carried. 
                </p>
                <p>
                ...
                <p>
                    He was tall, <span style = "color: yellow">blonde</span>, and good looking. Dreamy, as my mother would put it. 
                </p>
                <p>
                ...
                <p>
                    He carried about him an aura of confidence. If the man’s hair wasn’t <span style = "color: gray">gray</span>, he could have easily passed for a man in his late twenties. 
                </p>
                <p>
                ...
                <p>He proceeded to sit down next to me, out of all the empty seats in the room. He placed his stuff down at his feet, and reclined with a groan.</p>
                <p>
                ...
                <p>
                    He smiled. “Where are you from kid?” he asked.
                </p>
                <p>
                ...
                <p>
                    The most noticeable feature about him, however, was his eyes. They were colored <span style = "color: blue">ocean blue</span>, glowing like those night lights that I (over)used as a kid.
                </p>
                <p>My mother was highly intelligent. She was offered a government position straight out of college, but declined “because she didn’t want anything to do with politics”. Instead, she chose the humble life of an author. </p>
                <p>
                    She wrote a lot of books. Most of these books didn’t sell well though. She always remained positive, however.
                </p>
                 <p>
                    I missed my parents.
                </p>
                ...
                <div class="pbutton-group">
                    <a href="./ch1_talk.php" class="pbutton">Talk About It</a>
                    <a href="./ch1_donttalk.php" class="pbutton">Don't Talk About It</a>
                </div>
            </div>
        </div>
    </body>
